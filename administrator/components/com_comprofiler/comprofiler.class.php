...
* @version $Id: comprofiler.class.php 1457 2011-02-13 23:41:32Z beat $
...
function outputCbJs( ) {
	...
	if ( $needOut-- ) {
		...
		$jsVers		=	md5( $ueConfig['version'] . $_CB_framework->getCfg( 'live_site' ) );	
		$_CB_framework->document->addHeadScriptUrl( '/components/com_comprofiler/js/cb12.js?' . $jsVers, true );
	}
}
